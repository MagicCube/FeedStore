...
- (void)viewDidLoad {
    ...
    UISwipeGestureRecognizer *swipeRight = [[UISwipeGestureRecognizer alloc] initWithTarget:self action:@selector(_swipeRightAction:)];
...
-(IBAction)_swipeRightAction:(UISwipeGestureRecognizer*)sender
{
